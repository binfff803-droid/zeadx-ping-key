...
def admin_dashboard():
    ...
    <style>
      ...
      .copy-mini{{ display:flex; align-items:center; gap:5px; border:none; border-radius:6px; padding:7px 10px; font-family:'Rajdhani',sans-serif; font-size:11.5px; font-weight:700; letter-spacing:0.03em; color:#031018; cursor:pointer; background:linear-gradient(135deg, #7dd3fc, var(--ocean) 55%); white-space:nowrap; }}
